...
function Description({ t }) {
  return (
    ...
    <div className="Description" class="flex flex flex-col items-center	 place-items-center font-mono  mx-auto py-5 my-20 text-center sm:text-left">
      <div className="DemoSetTitle" class=" text-2xl sm:text-4xl font-nanifont my-12 p-4 text-center rounded-2xl m-5 z-40 -mb-16 violet text-white shadow-gl w-5/12	">
      {t('Voting')}
      </div>
