...
function DemoSet({ t }) {
  return (
    <div className="DemoSet" class="flex flex-col center w-full 	items-center backdrop-brightness-200 violet sm:bg-transparent 	">
      <div className="DemoSetTitle" class=" text-4xl sm:text-4xl  text-white font-nanifont my-12 p-4 text-center rounded-2xl m-5  mb-5 violet w-6/12 lg:w-3/12	">
        {t('EventName')}
      </div>
...
export default  withTranslation()(DemoSet);
